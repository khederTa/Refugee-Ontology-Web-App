...
def addInstance(onto):
    ...
    with onto:
        ...
        refugee_individual.refAgency = [onto.RefAgency(highagency)] if highagency else passIt()
        refugee_individual.refAgency = [onto.RefAgency(lowagency)] if lowagency else passIt()
        refugee_individual.hasExpectedLevelOfReintegration = [onto.Reintegration(economicWellbeing)] if economicWellbeing else passIt()
        refugee_individual.hasExpectedLevelOfReintegration = [onto.Reintegration(politicalProcess)] if politicalProcess else passIt()
        refugee_individual.hasExpectedLevelOfReintegration = [onto.Reintegration(socialCapital)] if socialCapital else passIt()
        refugee_individual.hasLevelOfIntegration = [onto.Integration(culturalIntegration)] if culturalIntegration else passIt()
        refugee_individual.hasLevelOfIntegration = [onto.Integration(economicIntegration)] if economicIntegration else passIt()
        refugee_individual.hasLevelOfIntegration = [onto.Integration(socialIntegration)] if socialIntegration else passIt()
        refugee_individual.practiceTransnationalism = [onto.Transnationalism(transnationalism)] if transnationalism else passIt()
